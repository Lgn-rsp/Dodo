# LOGOS — Directory Book: /var/www/logos/landing
...
### FILE: /var/www/logos/landing/landing/logos_tg_bot/logos_guard_bot/.env.example

```
BOT_TOKEN=REPLACE_ME_WITH_REAL_TOKEN
